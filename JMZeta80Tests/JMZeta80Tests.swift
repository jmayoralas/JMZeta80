...
class JMZeta80Tests: XCTestCase {
    ...
    func test_jr_e() {
        ...
        XCTAssertEqual(cycles, 12 + 4 + 3 + 5)
    ...
    func test_add_hl_ss() {
        ...
        XCTAssert(cycles == 11 + 11 + 11 + 11 + 11 + 11)
    }
    ...
    func test_dec_hli() {
        ...
        XCTAssert(cycles == 11 + 11 + 11 + 11 + 11)
    }
    func test_ld_r_n() {
        cpu.reset()
